...
describe('resolveKardexPrices — faithful comprobante, immune to re-pricing', () => {
  ...
  // (SOT v3: the live recompute resolves `precioFinalCOP`, not the retired
  // embajador/consciente tiers.)
  const liveItems = [
    { itemId: 'G-1', precioFinalCOP: 9999 },
    { itemId: 'G-2', precioFinalCOP: 8888 },
  ];
