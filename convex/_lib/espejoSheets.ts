...
export const TEXTO_LEEME = [
  ...
  ['  equilibrioReal = K/0,71 con IVA · K/0,90 sin → utilidad cero exacta.'],
  ['     De acá para abajo, ni con descuento.'],
  ['  precioObjetivo = K/0,41 con IVA · K/0,60 sin → equilibrio + 30% neto.'],
  ['  Qué IVA carga cada categoría lo dice la config vigente por fecha:'],
  ['     desde ago-2026 la gema también paga 19% (TM es responsable de IVA).'],
  [''],
