 ...
 * Y excluye la fila CENTINELA de las agrupaciones reconstruidas: no es un
 * proveedor, y ofrecerla al capturar un lote invitaría a atribuirle una compra.
 * `get` (por id) NO la filtra a propósito — en la ficha del lote ese nombre tiene
 * que verse, que es justamente para lo que existe.
 */
