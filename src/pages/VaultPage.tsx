...
const VaultPage: React.FC = () => {
  ...
  // Ambassador-specific combinations are verified server-side now
  // (api/vault-unlock.ts, N5 — 2026-08 fix round 3), so this page no longer
  // needs to fetch the asesor roster just to build a local code Map.
          ...
          <Box>
            <Box sx={{ maxWidth: 600, mx: 'auto', px: 2, py: 4 }}>
              ...
              >
                ...
                >
                  La Bóveda Secreta es un espacio reservado para las{' '}
                  <strong>gemas más exclusivas y raras</strong> de nuestra
                  colección. A diferencia del inventario general, este espacio
                  está curado personalmente por la administración.
                </Typography>
                <Typography
                  variant="body2"
                  sx={{ color: 'text.secondary', lineHeight: 1.7 }}
                >
                  Las piezas que aparecerán aquí son{' '}
                  <strong>seleccionadas cuidadosamente</strong> por su
                  excepcional calidad, rareza o características únicas que las
                  hacen verdaderos tesoros de colección.
                </Typography>
              </Paper>
              ...
              >
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  Estamos preparando una colección especial de gemas
                  extraordinarias. Pronto podrás explorar tesoros únicos en este
                  espacio exclusivo.
                </Typography>
              </Paper>
            </Box>
