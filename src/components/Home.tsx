...
const KNOWLEDGE_CATEGORIES = [
  { id: 'spiritual', title: 'Espiritualidad', icon: <SelfImprovement />, color: '#9C27B0', facts: 12 },
  { id: 'investment', title: 'Inversión', icon: <TrendingUp />, color: '#4CAF50', facts: 8 },
  { id: 'history', title: 'Historia', icon: <HistoryEdu />, color: '#FF9800', facts: 15 },
  { id: 'jewelry', title: 'Joyería', icon: <Diamond />, color: '#2196F3', facts: 10 },
  { id: 'meditation', title: 'Meditación', icon: <Spa />, color: '#E91E63', facts: 6 },
];
