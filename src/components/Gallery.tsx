...
export default function Gallery() {
  ...
  if (totalCount === 0) {
    return (
      <Box sx={{ maxWidth: 960, mx: 'auto', px: { xs: 2, sm: 3, md: 0 } }}>
        ...
        >
          ...
          />
          <Box sx={{ p: { xs: 2, sm: 2.5, md: 3 }, pt: { xs: 2.5, md: 3.5 } }}>
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', px: { xs: 2, sm: 3, md: 0 } }}>
      ...
      {/* Stats Cards */}
      <Box sx={{ display: 'grid', gridTemplateColumns: { xs: 'repeat(2, 1fr)', sm: 'repeat(2, 1fr)', md: 'repeat(4, 1fr)' }, gap: { xs: 1.5, md: 2 }, mb: { xs: 3, md: 4 } }}>
        {/* Total */}
        <Paper
          elevation={0}
          sx={{
