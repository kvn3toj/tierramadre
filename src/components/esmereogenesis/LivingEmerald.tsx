  ...
  return (
    ...
    >
      ...
      <Box
        ...
        animate={
          reducedMotion || !isPulsing ? undefined : { scale: [1, 1.025, 1] }
        }
          ...
          {SPARKLE_POSITIONS.map((s, i) => (
            <Box
              ...
              sx={{
                ...
                background: "#FFFFFF",
                borderRadius: "50%",
                boxShadow: `0 0 8px ${whiteAlpha(0.9)}, 0 0 14px ${alpha(goldAccent.primary, 0.7)}`,
              }}
              animate={{
                scale: [0, 1, 0],
                opacity: [0, 1, 0],
