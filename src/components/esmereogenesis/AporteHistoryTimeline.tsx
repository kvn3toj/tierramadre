...
export const AporteHistoryTimeline: React.FC<AporteHistoryTimelineProps> = ({
  ...
  const amountColor = isLight ? emeraldCore.dark : PEARL_SURFACE;
  const subtitleColor = isLight
    ? alpha(emeraldCore.dark, 0.6)
    : whiteAlpha(0.62);
    ...
    return (
      ...
      >
        <Typography variant="body2">
          Aún no has hecho aportes. Cuando riegues por primera vez, los verás
          aquí.
        </Typography>
      </Box>
    );
              ...
              <Box sx={{ flex: 1, minWidth: 0 }}>
                <Typography
                  ...
                  sx={{
                    ...
                    textShadow: isLight
                      ? "none"
                      : `0 1px 8px ${alpha(emeraldCore.dark, 0.45)}`,
                  }}
                >
