...
const SYMBOL_PATHS: Record<VaultSymbolId, string> = {
  ...
  sol:
    'M8 12 A4 4 0 0 1 16 12 A4 4 0 0 1 8 12 M12 1 L12 3 M12 21 L12 23 M4.22 4.22 L5.64 5.64 M18.36 18.36 L19.78 19.78 M1 12 L3 12 M21 12 L23 12 M4.22 19.78 L5.64 18.36 M18.36 5.64 L19.78 4.22',
  luna:
  ...
  ojo:
    'M2 12 Q7 4 12 4 Q17 4 22 12 Q17 20 12 20 Q7 20 2 12 Z M8 12 A4 4 0 0 1 16 12 A4 4 0 0 1 8 12 M10 12 A2 2 0 0 1 14 12 A2 2 0 0 1 10 12',
  estrella:
  ...
  corazon_verde:
    'M12 21 C7 16 3 13 3 8.5 A4.5 4.5 0 0 1 12 6.5 A4.5 4.5 0 0 1 21 8.5 C21 13 17 16 12 21 Z',
};
