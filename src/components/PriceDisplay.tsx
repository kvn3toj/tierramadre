...
export interface PriceDisplayProps {
  ...
  /** Moneda (default: COP) */
  currency?: 'COP' | 'USD';
  /** Mostrar precio nacional con descuento */
  showNational?: boolean;
  /** Porcentaje de descuento nacional (default: 0.20 = 20%) */
...
export const PriceDisplay = ({
  ...
  const nationalPrice = Math.round(price * (1 - nationalDiscount));
  const discountPercent = Math.round(nationalDiscount * 100);
      ...
      <Stack spacing={0.25}>
        <Typography
          ...
          sx={{
            ...
            textDecoration: showNational ? 'line-through' : 'none',
            fontSize: showNational ? '0.7rem' : '0.85rem',
          }}
        >
          {formatCompact(price)}
        </Typography>
