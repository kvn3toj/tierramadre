...
export const goldGradients = {
  /** Soft gold gradient */
  light: 'linear-gradient(135deg, #FDF8E8 0%, #F5E6A3 100%)',
  /** Medium gold gradient */
  medium: 'linear-gradient(135deg, #E5C866 0%, #D4AF37 100%)',
  /** Deep gold gradient */
  deep: 'linear-gradient(135deg, #D4AF37 0%, #B8941F 100%)',
  /** Intense gold gradient */
  intense: 'linear-gradient(135deg, #B8941F 0%, #665210 100%)',
} as const;
...
export const qualityGradients = {
  ...
  sublime: 'linear-gradient(135deg, #006A48 0%, #004830 50%, #D4AF37 100%)',
...
export const backgroundGradients = {
  ...
  /** Subtle emerald tint */
  subtle: 'linear-gradient(180deg, rgba(0, 174, 122, 0.02) 0%, rgba(0, 174, 122, 0.08) 100%)',
} as const;
...
export const radialGradients = {
  ...
  emeraldSpotlight: 'radial-gradient(circle at 50% 50%, rgba(0, 174, 122, 0.2) 0%, transparent 70%)',
  /** Gold spotlight effect */
  goldSpotlight: 'radial-gradient(circle at 50% 50%, rgba(212, 175, 55, 0.2) 0%, transparent 70%)',
  /** Card hover glow */
  hoverGlow: 'radial-gradient(circle at 50% 50%, rgba(0, 174, 122, 0.15) 0%, transparent 60%)',
  /** Center light */
  centerLight: 'radial-gradient(circle at 50% 50%, rgba(255, 255, 255, 0.8) 0%, transparent 70%)',
  /** Vignette effect */
  vignette: 'radial-gradient(circle at 50% 50%, transparent 40%, rgba(0, 0, 0, 0.1) 100%)',
} as const;
...
export const conicGradients = {
  /** Emerald spectrum */
  emeraldSpectrum: 'conic-gradient(from 0deg, #33C194, #00AE7A, #008C61, #006A48, #004830, #006A48, #008C61, #00AE7A, #33C194)',
  /** Gold spectrum */
  goldSpectrum: 'conic-gradient(from 0deg, #F5E6A3, #E5C866, #D4AF37, #B8941F, #8F7318, #B8941F, #D4AF37, #E5C866, #F5E6A3)',
  /** Sublime (emerald + gold) */
  sublimeSpectrum: 'conic-gradient(from 0deg, #006A48, #D4AF37, #004830, #B8941F, #006A48)',
} as const;
...
export const buttonGradients = {
  ...
  secondaryHover: 'linear-gradient(135deg, #E5C866 0%, #D4AF37 100%)',
  /** Danger button */
...
export const meshGradients = {
  ...
  gold: `
    ...
    radial-gradient(at 80% 0%, rgba(184, 148, 31, 0.2) 0px, transparent 50%),
    radial-gradient(at 0% 50%, rgba(143, 115, 24, 0.2) 0px, transparent 50%),
    radial-gradient(at 80% 50%, rgba(229, 200, 102, 0.15) 0px, transparent 50%)
  `,
  /** Sublime mesh (emerald + gold) */
  sublime: `
    radial-gradient(at 20% 30%, rgba(0, 174, 122, 0.25) 0px, transparent 50%),
    radial-gradient(at 80% 20%, rgba(212, 175, 55, 0.2) 0px, transparent 50%),
    radial-gradient(at 50% 80%, rgba(0, 106, 72, 0.2) 0px, transparent 50%),
    radial-gradient(at 90% 70%, rgba(184, 148, 31, 0.15) 0px, transparent 50%)
  `,
} as const;
