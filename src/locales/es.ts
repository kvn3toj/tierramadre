...
export const es = {
  ...
  tools: {
    ...
    invitation: {
      ...
      description: 'Genera un enlace temporal para que tu cliente explore esmeraldas colombianas.',
      ...
      sharePinSeparately: 'Comparte el PIN por separado (WhatsApp, llamada, etc.)',
      withPrices: 'Con precios',
      withoutPrices: 'Sin precios',
      share: 'Compartir',
      shareTitle: 'Tierra Madre - Invitación',
      shareText: 'Hola {name}, te invito a explorar nuestra colección de esmeraldas colombianas. Este enlace es válido por 24 horas.',
  ...
  ambassador: {
    ...
    loadError: 'No se pudieron cargar los embajadores. Recarga la página para intentar de nuevo.',
